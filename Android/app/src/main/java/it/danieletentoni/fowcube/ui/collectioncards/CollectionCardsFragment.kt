 ...
 * [CollectionCardsFragment.OnListFragmentInteractionListener] interface.
 */
class CollectionCardsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyCardListItemRecyclerViewAdapter(DummyContent.ITEMS, listener)
            }
        }
        return view
    }
